...
function Card({ title, description, rotation, cardId }: CardProps) {
  ...
  return (
    <div
      ...
      className={`focus:ring-2 focus:outline-green-300 w-[120px] h-[160px] sm:w-[135px] sm:h-[180px] 
        md:w-[150px] md:h-[200px] touch-none cursor-pointer select-none bg-gray-100 p-4 
        border-black border-4 rounded-lg ${rotation} 
